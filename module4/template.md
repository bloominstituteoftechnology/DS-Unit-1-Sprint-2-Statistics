...
What decisions do you face?
- What precisely to focus on, be it specific districts vs states vs nationwide
...
2. Trend related to the news
- Politics are always somewhat newsworthy, but districts will be redrawn after the 2020 census so it is particularly interesting now

3. Who does that?
- All US voters might find the data interesting

4. Answering a question people care about
- Redistricting is something that politically active people care about, but unfortunately the general public does not

5. Valuable to businesses
- Unlikely to be of specific benefit to businesses

6. What's the most popular?
- Comparing popular vote results to end results might fit this template

7. Cost/Money rankings
- Campaign costs might be interesting to include with redistricting data to show how campaign funds can be reapportioned following redistricting

## Misconceptions

What misconceptions do people have about your topic?
- Gerrymandering is one-sided (though it may be shown to benefit one party more than the other, both parties engage in politically motivated redistricting)
- SCOTUS has ruled that gerrymandering is acceptable (they have not)
...
Could you do a new question, for the same topic?
- As mentioned a bit above, it might be interesting to look at targeted campaign funding before and after redistricting

Could you do a new topic, with the same "style"?
- This style of the above article lends itself to any question of statewide demographics and/or voting results
